# Script to download Tuesday's WWDC 22 session videos in the highest 4K video and audio
...
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2022/10066/4/3B036508-C4CA-4DA9-AE0F-83A6E607ADF8/cmaf/hvc/2160p_16800/hvc_2160p_16800.m3u8 -c copy "Session - 10066 temp.mp4"
...
ffmpeg -i "Session - 110930 temp.mp4" -i "Session - 110930 temp.aac" -i "Session - 110930 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 110930 - Tuesday@WWDC22 (2160p).mp4"
