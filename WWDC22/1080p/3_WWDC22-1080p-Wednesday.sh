# Script to download Wednesday's WWDC 22 session videos in the highest 1080p video and audio
...
ffmpeg -i "Session - 10103 temp.mp4" -i "Session - 10103 temp.aac" -c copy "Session 10103 - Boost performance with MetalFX Upscaling (1080p).mp4"
...
ffmpeg -i https://events-delivery.apple.com/wwdc22/S6609-rUNWRhfHEGjdhBffWQLkyEHB/sdr_avc_540p_2000/prog_index.m3u8 -c copy "Session - 10113 temp.mp4"
...
ffmpeg -i "Session - 10113 temp.mp4" -i "Session - 10113 temp.aac" -i "Session - 10113 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10113 - Explore EDR on iOS (540p).mp4"
