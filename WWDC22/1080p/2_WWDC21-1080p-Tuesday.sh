...
ffmpeg -i "Session - 10151 temp.mp4" -i "Session - 10151 temp.aac" -c copy "Session 10151 - Add accessibility to your Unity games (1080p).mp4"
...
ffmpeg -i "Session - 10071 temp.mp4" -i "Session - 10071 temp.aac" -c copy "Session 10071 - Adopt desktop class editing interactions (1080p).mp4"
...
ffmpeg -i "Session - 10158 temp.mp4" -i "Session - 10158 temp.aac" -c copy "Session 10158 - Adopt Variable Color in SF Symbols (1080p).mp4"
...
ffmpeg -i "Session - 10018 temp.mp4" -i "Session - 10018 temp.aac" -c copy "Session 10018 - Bring Continuity Camera to your macOS app (1080p).mp4"
...
ffmpeg -i "Session - 110373 temp.mp4" -i "Session - 110373 temp.aac" -c copy "Session 110373 - Bring your driver to iPad with DriverKit (1080p).mp4"
...
ffmpeg -i "Session - 10128 temp.mp4" -i "Session - 10128 temp.aac" -c copy "Session 10128 - Bring your world into augmented reality (1080p).mp4"
...
ffmpeg -i "Session - 110348 temp.mp4" -i "Session - 110348 temp.aac" -c copy "Session 110348 - Build your first app in Swift Playgrounds (1080p).mp4"
...
ffmpeg -i "Session - 10025 temp.mp4" -i "Session - 10025 temp.aac" -c copy "Session 10025 - Capture machine-readable codes and text with VisionKit (1080p).mp4"
...
ffmpeg -i "Session - 10050 temp.mp4" -i "Session - 10050 temp.aac" -c copy "Session 10050 - Complications and widgets - Reloaded (1080p).mp4"
...
ffmpeg -i "Session - 110379 temp.mp4" -i "Session - 110379 temp.aac" -c copy "Session 110379 - Create a more responsive media app (1080p).mp4"
...
ffmpeg -i "Session - 10002 temp.mp4" -i "Session - 10002 temp.aac" -c copy "Session 10002 - Create macOS or Linux virtual machines (1080p).mp4"
...
ffmpeg -i "Session - 10127 temp.mp4" -i "Session - 10127 temp.aac" -c copy "Session 10127 - Create parametric 3D room scans with RoomPlan (1080p).mp4"
...
ffmpeg -i "Session - 10144 temp.mp4" -i "Session - 10144 temp.aac" -c copy "Session 10144 - Deliver reliable streams with HLS Content Steering (1080p).mp4"
...
ffmpeg -i "Session - 10032 temp.mp4" -i "Session - 10032 temp.aac" -c copy "Session 10032 - Dive into App Intents (1080p).mp4"
...
ffmpeg -i "Session - 10095 temp.mp4" -i "Session - 10095 temp.aac" -c copy "Session 10095 - Enhance collaboration experiences with Messages (1080p).mp4"
...
ffmpeg -i "Session - 10117 temp.mp4" -i "Session - 10117 temp.aac" -c copy "Session 10117 - Enhance voice communication with Push to Talk (1080p).mp4"
...
ffmpeg -i "Session - 110347 temp.mp4" -i "Session - 110347 temp.aac" -c copy "Session 110347 - Explore more content with MusicKit (1080p).mp4"
...
ffmpeg -i "Session - 10016 temp.mp4" -i "Session - 10016 temp.aac" -c copy "Session 10016 - Get more mileage out of your app with CarPlay (1080p).mp4"
...
ffmpeg -i "Session - 110374 temp.mp4" -i "Session - 110374 temp.aac" -c copy "Session 110374 - Get the most out of Xcode Cloud (1080p).mp4"
...
ffmpeg -i "Session - 10135 temp.mp4" -i "Session - 10135 temp.aac" -c copy "Session 10135 - Get timely alerts from Bluetooth devices on watchOS (1080p).mp4"
...
ffmpeg -i "Session - 10019 temp.mp4" -i "Session - 10019 temp.aac" -c copy "Session 10019 - Get to know Create ML Components (1080p).mp4"
...
ffmpeg -i "Session - 110344 temp.mp4" -i "Session - 110344 temp.aac" -c copy "Session 110344 - Get to know Developer Mode (1080p).mp4"
...
ffmpeg -i "Session - 10136 temp.mp4" -i "Session - 10136 temp.aac" -c copy "Session 10136 - Hello Swift Charts (1080p).mp4"
...
ffmpeg -i "Session - 10170 temp.mp4" -i "Session - 10170 temp.aac" -c copy "Session 10170 - Implement App Shortcuts with App Intents (1080p).mp4"
...
ffmpeg -i "Session - 10104 temp.mp4" -i "Session - 10104 temp.aac" -c copy "Session 10104 - Load resources faster with Metal 3 (1080p).mp4"
...
ffmpeg -i "Session - 10006 temp.mp4" -i "Session - 10006 temp.aac" -c copy "Session 10006 - Meet Apple Maps Server APIs (1080p).mp4"
...
ffmpeg -i "Session - 10069 temp.mp4" -i "Session - 10069 temp.aac" -c copy "Session 10069 - Meet desktop class iPad (1080p).mp4"
...
ffmpeg -i "Session - 10121 temp.mp4" -i "Session - 10121 temp.aac" -c copy "Session 10121 - Meet Focus filters (1080p).mp4"
...
ffmpeg -i "Session - 10092 temp.mp4" -i "Session - 10092 temp.aac" -c copy "Session 10092 - Meet passkeys (1080p).mp4"
rm "Session - 10092 temp.mp4"
rm "Session - 10092 temp.aac"

# 30
# Session 110355 - Meet Swift Async Algorithms
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2022/110355/3/BAB81661-430E-436D-8B9C-8BB838F72193/cmaf/hvc/1080p_5800/hvc_1080p_5800.m3u8 -c copy "Session - 110355 temp.mp4"
...
ffmpeg -i "Session - 110355 temp.mp4" -i "Session - 110355 temp.aac" -c copy "Session 110355 - Meet Swift Async Algorithms (1080p).mp4"
...
ffmpeg -i "Session - 110357 temp.mp4" -i "Session - 110357 temp.aac" -c copy "Session 110357 - Meet Swift Regex (1080p).mp4"
...
ffmpeg -i "Session - 10003 temp.mp4" -i "Session - 10003 temp.aac" -c copy "Session 10003 - Meet WeatherKit (1080p).mp4"
...
ffmpeg -i "Session - 10098 temp.mp4" -i "Session - 10098 temp.aac" -c copy "Session 10098 - Meet Web Push for Safari (1080p).mp4"
...
ffmpeg -i "Session - 10065 temp.mp4" -i "Session - 10065 temp.aac" -c copy "Session 10065 - Plug-in and play - Add Apple frameworks to your Unity game projects (1080p).mp4"
...
ffmpeg -i "Session - 10131 temp.mp4" -i "Session - 10131 temp.aac" -c copy "Session 10131 - Qualities of great AR experiences (1080p).mp4"
...
ffmpeg -i "Session - 10054 temp.mp4" -i "Session - 10054 temp.aac" -c copy "Session 10054 - The SwiftUI cookbook for navigation (1080p).mp4"
...
ffmpeg -i "Session - 110350 temp.mp4" -i "Session - 110350 temp.aac" -c copy "Session 110350 - Visualize and optimize Swift concurrency (1080p).mp4"
...
ffmpeg -i "Session - 10097 temp.mp4" -i "Session - 10097 temp.aac" -c copy "Session 10097 - What's new in App Clips (1080p).mp4"
...
ffmpeg -i "Session - 10074 temp.mp4" -i "Session - 10074 temp.aac" -c copy "Session 10074 - What's new in AppKit (1080p).mp4"
...
ffmpeg -i "Session - 110332 temp.mp4" -i "Session - 110332 temp.aac" -c copy "Session 110332 - What's new in Create ML (1080p).mp4"
...
ffmpeg -i "Session - 10045 temp.mp4" -i "Session - 10045 temp.aac" -c copy "Session 10045 - What's new in managing Apple devices (1080p).mp4"
...
ffmpeg -i "Session - 10008 temp.mp4" -i "Session - 10008 temp.aac" -c copy "Session 10008 - What's new in Nearby Interaction (1080p).mp4"
...
ffmpeg -i "Session - 10048 temp.mp4" -i "Session - 10048 temp.aac" -c copy "Session 10048 - What's new in Safari and WebKit (1080p).mp4"
...
ffmpeg -i "Session - 10157 temp.mp4" -i "Session - 10157 temp.aac" -c copy "Session 10157 - What's new in SF Symbols 4 (1080p).mp4"
...
ffmpeg -i "Session - 10140 temp.mp4" -i "Session - 10140 temp.aac" -c copy "Session 10140 - What's new in SharePlay (1080p).mp4"
...
ffmpeg -i "Session - 110354 temp.mp4" -i "Session - 110354 temp.aac" -c copy "Session 110354 - What's new in Swift (1080p).mp4"
...
ffmpeg -i "Session - 10052 temp.mp4" -i "Session - 10052 temp.aac" -c copy "Session 10052 - What's new in SwiftUI (1080p).mp4"
...
ffmpeg -i "Session - 10068 temp.mp4" -i "Session - 10068 temp.aac" -c copy "Session 10068 - What's new in UIKit (1080p).mp4"
...
ffmpeg -i "Session - 110427 temp.mp4" -i "Session - 110427 temp.aac" -c copy "Session 110427 - What's new in Xcode (1080p).mp4"
...
ffmpeg -i "Session - 10007 temp.mp4" -i "Session - 10007 temp.aac" -c copy "Session 10007 - What's new with in-app purchase (1080p).mp4"
...
ffmpeg -i "Session - 10109 temp.mp4" -i "Session - 10109 temp.aac" -c copy "Session 10109 - What’s new in notarization for Mac apps (1080p).mp4"
