...
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/400/2/71024f51-e63d-4684-b97c-39b7b148238f/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 400 temp.mp4"
...
ffmpeg -i "Session - 400 temp.mp4" -i "Session - 400 temp.aac" -i "Session - 400 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 400 - Dub Dub Daily - Day 5 (1440p).mp4"
...
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/382/1/a1dfe905-059c-45b1-b109-e68230f76399/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 382 temp.mp4"
...
ffmpeg -i "Session - 382 temp.mp4" -i "Session - 382 temp.aac" -i "Session - 382 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 382 - Inside Apple Intelligence and Xcode - Special Presentation (1440p).mp4"
