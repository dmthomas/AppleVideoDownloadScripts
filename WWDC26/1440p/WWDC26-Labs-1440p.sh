...
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8005/1/88a5239b-516e-46f5-ad8b-2c1bc613d3b3/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8005 temp.mp4"
...
ffmpeg -i "Session - 8005 temp.mp4" -i "Session - 8005 temp.aac" -c copy "Session 8005 - Accessibility Technologies Group Lab (1440p).mp4"
rm "Session - 8005 temp.mp4"
rm "Session - 8005 temp.aac"

# 2
# Session 8010 - App Store Connect Group Lab
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8010/1/fb64e95b-57b3-4c1b-86c1-4afeaaa8f7a4/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8010 temp.mp4"
...
ffmpeg -i "Session - 8010 temp.mp4" -i "Session - 8010 temp.aac" -c copy "Session 8010 - App Store Connect Group Lab (1440p).mp4"
rm "Session - 8010 temp.mp4"
rm "Session - 8010 temp.aac"

# 3
# Session 8011 - Apple Intelligence Group Lab
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8011/1/feca06d1-a4cd-4fe2-8515-4d86dbd89222/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8011 temp.mp4"
...
ffmpeg -i "Session - 8011 temp.mp4" -i "Session - 8011 temp.aac" -c copy "Session 8011 - Apple Intelligence Group Lab (1440p).mp4"
rm "Session - 8011 temp.mp4"
rm "Session - 8011 temp.aac"

# 4
# Session 8018 - Camera and Photo Technologies Group Lab
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8018/1/93e6857e-510f-4d8a-adc4-7c6ce9eb9fe8/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8018 temp.mp4"
...
ffmpeg -i "Session - 8018 temp.mp4" -i "Session - 8018 temp.aac" -c copy "Session 8018 - Camera and Photo Technologies Group Lab (1440p).mp4"
rm "Session - 8018 temp.mp4"
rm "Session - 8018 temp.aac"

# 5
# Session 8007 - Coding Intelligence for Beginners Group Lab
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8007/1/139f5980-6b60-45d2-a874-62159a1f5fcc/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8007 temp.mp4"
...
ffmpeg -i "Session - 8007 temp.mp4" -i "Session - 8007 temp.aac" -c copy "Session 8007 - Coding Intelligence for Beginners Group Lab (1440p).mp4"
rm "Session - 8007 temp.mp4"
rm "Session - 8007 temp.aac"

# 6
# Session 8121 - Coding Intelligence, Machine Learning & AI Group Lab
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8121/1/a84fe3e3-b640-4faa-9685-207aec99be2d/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8121 temp.mp4"
...
ffmpeg -i "Session - 8121 temp.mp4" -i "Session - 8121 temp.aac" -c copy "Session 8121 - Coding Intelligence, Machine Learning & AI Group Lab (1440p).mp4"
rm "Session - 8121 temp.mp4"
rm "Session - 8121 temp.aac"

# 7
# Session 8012 - Icon Composer for Beginners Group Lab
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2026/8012/1/318b62a0-198d-48c5-8a8e-84fd39de45bd/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 8012 temp.mp4"
...
ffmpeg -i "Session - 8012 temp.mp4" -i "Session - 8012 temp.aac" -c copy "Session 8012 - Icon Composer for Beginners Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8003 temp.mp4" -i "Session - 8003 temp.aac" -c copy "Session 8003 - Power and Performance Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8009 temp.mp4" -i "Session - 8009 temp.aac" -c copy "Session 8009 - Privacy and Security Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8015 temp.mp4" -i "Session - 8015 temp.aac" -c copy "Session 8015 - Safari and Web Technologies Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8001 temp.mp4" -i "Session - 8001 temp.aac" -c copy "Session 8001 - Swift Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8002 temp.mp4" -i "Session - 8002 temp.aac" -c copy "Session 8002 - SwiftUI for Beginners Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8006 temp.mp4" -i "Session - 8006 temp.aac" -c copy "Session 8006 - SwiftUI Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8120 temp.mp4" -i "Session - 8120 temp.aac" -c copy "Session 8120 - SwiftUI Group Lab  (1440p).mp4"
...
ffmpeg -i "Session - 8004 temp.mp4" -i "Session - 8004 temp.aac" -c copy "Session 8004 - visionOS Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8014 temp.mp4" -i "Session - 8014 temp.aac" -c copy "Session 8014 - watchOS Group Lab (1440p).mp4"
...
ffmpeg -i "Session - 8013 temp.mp4" -i "Session - 8013 temp.aac" -c copy "Session 8013 - Xcode Tips and Tricks Group Lab (1440p).mp4"
