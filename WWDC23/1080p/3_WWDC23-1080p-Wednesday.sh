...
ffmpeg -i "Session - 110931 temp.mp4" -i "Session - 110931 temp.aac" -i "Session - 110931 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 110931 - Wednesday@WWDC22 (1080p).mp4"
