# Script to download Tuesday's WWDC 23 session videos in the highest 4K video and audio
...
ffmpeg -i "Session - 10124 temp.mp4" -i "Session - 10124 temp.aac" -i "Session - 10124 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10124 - Bring your game to Mac - Compile your shaders (2160p).mp4"
...
ffmpeg -i "Session - 10123 temp.mp4" -i "Session - 10123 temp.aac" -i "Session - 10123 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10123 - Bring your game to Mac - Make a game plan (2160p).mp4"
...
ffmpeg -i "Session - 10125 temp.mp4" -i "Session - 10125 temp.aac" -i "Session - 10125 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10125 - Bring your game to Mac - Render with Metal (2160p).mp4"
...
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2023/10181/4/B669E5B5-B6C7-40D3-AF7D-801FBEE8FF55/cmaf/hvc/2160p_16800/hvc_2160p_16800.m3u8 -c copy "Session - 10181 temp.mp4"
...
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2023/10040/4/9811F773-822B-4DEA-8F00-612829F3DC0E/cmaf/hvc/2160p_16800/hvc_2160p_16800.m3u8 -c copy "Session - 10040 temp.mp4"
...
ffmpeg -i "Session - 10040 temp.mp4" -i "Session - 10040 temp.aac" -i "Session - 10040 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10040 - What’s new in managing Apple devices (2160p).mp4"
