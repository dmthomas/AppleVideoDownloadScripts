# Script to download all the WWDC 23 session videos in the highest 1440p video and audio
...
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2023/10248/6/AB6FF62D-3A9D-4816-95E8-2E7B464CA1DF/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 10248 temp.mp4"
...
ffmpeg -i "Session - 10248 temp.mp4" -i "Session - 10248 temp.aac" -i "Session - 10248 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10248 - Analyze hangs with Instruments (1440p).mp4"
...
ffmpeg -i "Session - 10123 temp.mp4" -i "Session - 10123 temp.aac" -i "Session - 10123 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10123 - Bring your game to Mac, Part 1 - Make a game plan (1440p).mp4"
...
ffmpeg -i "Session - 10124 temp.mp4" -i "Session - 10124 temp.aac" -i "Session - 10124 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10124 - Bring your game to Mac, Part 2 - Compile your shaders (1440p).mp4"
...
ffmpeg -i "Session - 10125 temp.mp4" -i "Session - 10125 temp.aac" -i "Session - 10125 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10125 - Bring your game to Mac, Part 3 - Render with Metal (1440p).mp4"
...
ffmpeg -i http://events-delivery.apple.com/wwdc23/S8241_9fowekbjdowtk23gksd9/sdr_hvc_1440p_8100/prog_index.m3u8 -c copy "Session - 10181 temp.mp4"
...
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2023/10040/5/FAEE48F2-1B5D-4894-AEB1-1D02816D6347/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 10040 temp.mp4"
...
ffmpeg -i "Session - 10040 temp.mp4" -i "Session - 10040 temp.aac" -c copy "Session 10040 - What’s new in managing Apple devices (1440p).mp4"
