# Script to download Wednesday's WWDC 22 session videos in the highest 1440p video and audio
...
ffmpeg -i "Session - 10103 temp.mp4" -i "Session - 10103 temp.aac" -c copy "Session 10103 - Boost performance with MetalFX Upscaling (1440p).mp4"
...
# 54
# Session 110931 - Wednesday@WWDC22
...
ffmpeg -i "Session - 110931 temp.mp4" -i "Session - 110931 temp.aac" -i "Session - 110931 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 110931 - Wednesday@WWDC22 (1440p).mp4"
