...
ffmpeg -i "Session - 10210 temp.mp4" -i "Session - 10210 temp.aac" -c copy "Session 10210 - Bring your app’s core features to users with App Intents (1440p).mp4"
...
ffmpeg -i https://devstreaming-cdn.apple.com/videos/wwdc/2024/10139/4/E7140B6F-A877-45A2-B8B6-C1A6FB47140B/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 10139 temp.mp4"
...
ffmpeg -i "Session - 10139 temp.mp4" -i "Session - 10139 temp.aac" -i "Session - 10139 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 10139 - Introducing enterprise APIs for visionOS (1440p).mp4"
