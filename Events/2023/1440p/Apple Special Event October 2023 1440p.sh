# Apple Special Event October 2023 1440p

ffmpeg -i https://events-delivery.apple.com/2409nbcxymeynatwojbbrjuhryomtudb/vod_main_BwqDeqJgBbinxjxLXGwWjBLqDYgCgYXY/sdr_hvc_1440p_8100/prog_index.m3u8 -c copy "Apple Special Event October 2023 temp.mp4"
