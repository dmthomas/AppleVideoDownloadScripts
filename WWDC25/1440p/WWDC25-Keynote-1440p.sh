# WWDC25 Keynote
ffmpeg -extension_picky 0 -i https://events-delivery.apple.com/0705ssefukzgmvtafvdghmccmofevkcb/vod_main_tbRmxUmgfZUDgixPtvpuvDHQcDAUqvUq/sdr_hvc_1440p_8100/prog_index.m3u8 -c copy "WWDC 2025 Keynote temp.mp4"
