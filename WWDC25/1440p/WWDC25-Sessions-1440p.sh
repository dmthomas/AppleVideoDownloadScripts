...
ffmpeg -extension_picky 0 -i https://devstreaming-cdn.apple.com/videos/wwdc/2025/367/2/56654673-9cbe-4dc1-bdbe-7960bd7d92c2/cmaf/hvc/1440p_8100/hvc_1440p_8100.m3u8 -c copy "Session - 367 temp.mp4"
...
ffmpeg -i "Session - 367 temp.mp4" -i "Session - 367 temp.aac" -i "Session - 367 temp.vtt" -map 0:v -map 1:a -acodec copy -vcodec copy -map 2 -c:s:0 mov_text -metadata:s:s:0 language=eng "Session 367 - WWDC25 Platforms State of the Union Recap (1440p).mp4"
